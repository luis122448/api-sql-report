...
class ReportConfigLoader:
    ...
    def get_report_config(id_cia: int, id_report: int) -> Report | None:
        ...
        sql_query = "SELECT id_cia, company, id_report, name, query, swapi, refreshtime FROM pack_exceldinamico.sp_buscar_api(-1) WHERE id_cia = :id_cia AND id_report = :id_report"
