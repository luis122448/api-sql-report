...
from routers import extract_router, metadata_router, analytics_router, auth_router, usage_router, status_router
...
app.include_router(status_router.status_router, prefix="/api")
